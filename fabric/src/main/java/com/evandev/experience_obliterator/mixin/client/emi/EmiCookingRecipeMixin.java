...
public abstract class EmiCookingRecipeMixin {
    ...
    private TextWidget experience_obliterator$modifyCookingExperienceText(WidgetHolder instance, FormattedCharSequence text, int x, int y, int color, boolean shadow, Operation<TextWidget> original) {
